...
export default function Home() {
  ...
  return (
    <div>
      ...
      <p className="font-title-lg">Title.</p>
      <p className="font-title-md">Title.</p>
      <p className="font-title-sm">Title.</p>
      <p className="font-title-xs">Title.</p>
      <p className="font-body-xl">Body.</p>
